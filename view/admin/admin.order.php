              ...
              <div class="Filter">
                ...
                <div class="form-group">
                  ...
                  <select id="filter-district" name="district" onchange="this.form.submit()">  
                    ...
                    <option value="all" <?php echo (isset($_GET['district']) && $_GET['district'] == 'all') ? 'selected' : ''; ?>>Tất cả</option>
                    <?php 
                  ...
                  <select id="filter-ward " name="ward" onchange="this.form.submit()">
                    ...
                    <option value="all" <?php echo (isset($_GET['ward']) && $_GET['ward'] == 'all') ? 'selected' : ''; ?>>Tất cả</option>
                    <?php 
                  ...
                  <select id="filter-status" name="status" onchange="this.form.submit()">
                    ...
                    <option value="all" <?php if ($status_selected == 'all') echo 'selected'; ?>>Tất cả</option>
