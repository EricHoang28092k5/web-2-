...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 06:22 AM
...
(68, 12, 'Nguyễn Văn A', 'alphabella@gmail.com', '09876543210', '456/12A, Đường Nguyễn Thị Minh Khai, ', 'Quận 3', 'Phường 5', '2025-05-06 10:02:02', 410000, 2, 1),
(69, 12, 'Nguyễn Văn A', 'alphabella@gmail.com', '09876543210', '1596 Võ Văn Kiệt ', 'Quận 6', 'Phường 7', '2025-05-06 10:05:46', 310000, 1, 1),
...
(71, 16, 'Võ Hòa Bình', 'binhvo123@gmail.com', '09988776655', '269 Nguyễn Thị Nhỏ ', 'Quận 11', 'Phường 16', '2025-05-06 11:17:30', 860000, 2, 2),
(72, 16, 'Võ Hòa Bình', 'binhvo123@gmail.com', '09988776655', '269 Nguyễn Thị Nhỏ ', 'Quận 11', 'Phường 16', '2025-05-06 11:17:58', 619000, 2, 1);
...
(2, 2, 'Rau xào ngũ sắc', 60000, 'Rau xào ngũ sắc là món ăn hấp dẫn với sự kết hợp hài hòa của nhiều loại rau củ có màu sắc bắt mắt như cà rốt, ớt chuông, bông cải, đậu cô ve và nấm. Món ăn không chỉ giàu dinh dưỡng mà còn giòn ngon, đậm đà nhờ cách xào nhanh trên lửa lớn cùng gia vị', 'rau-xao-ngu-sac.jpg', 1, 5),
(3, 4, 'Trà đào chanh sả', 40000, 'Trà đào chanh sả là một loại đồ uống giải khát thơm ngon, hấp dẫn với sự kết hợp hoàn hảo của vị ngọt thanh từ đào, vị chua dịu của chanh, và hương thơm sả dịu nhẹ. Món đồ uống này không chỉ mang lại cảm giác sảng khoái mà còn rất tốt cho sức khỏe.', 'tra-dao-chanh-sa.jpg', 1, 23),
...
(8, 1, 'Cơm chiên cua', 90000, 'Cơm chiên cua là một món ăn thơm ngon, dễ làm và giàu dinh dưỡng, thường xuất hiện trong các bữa ăn gia đình hoặc thực đơn nhà hàng. Món ăn này kết hợp hương vị của cơm chiên vàng ươm, thịt cua ngọt thanh, cùng các loại rau củ tạo nên sự hấp dẫn khó ', 'com_chien_cua.png', 1, 6),
...
(10, 1, 'Bò lúc lắc', 180000, 'Bò lúc lắc là món ăn thơm ngon với thịt bò mềm mại, được xào nhanh tay cùng với hành tây, ớt chuông, tạo nên hương vị đậm đà và hấp dẫn.', 'bo-luc-lac.jpg', 1, 8),
...
(12, 4, 'Trà vải hoa hồng', 45000, 'Trà vải hoa hồng mang đến hương thơm ngọt ngào của vải hòa quyện cùng mùi thơm thanh mát của hoa hồng, là lựa chọn hoàn hảo để giải nhiệt mùa hè.', 'tra-vai-hoa-hong.jpg', 1, 13),
(13, 2, 'Canh rong biển chay', 75000, 'Canh rong biển chay là món ăn thanh mát, giàu dinh dưỡng với vị ngọt tự nhiên từ rong biển và đậu hũ non, rất thích hợp cho những bữa ăn nhẹ nhàng.', 'canh-rong-bien-chay.jpg', 1, 10),
(14, 1, 'Cá hồi áp chảo sốt chanh leo', 320000, 'Cá hồi áp chảo sốt chanh leo là món ăn đẳng cấp với cá hồi béo ngậy được áp chảo vàng giòn, kết hợp cùng sốt chanh leo chua ngọt, tạo nên hương vị tinh tế khó cưỡng.', 'ca-hoi-ap-chao-chanh-leo.jpg', 1, 6),
(15, 3, 'Lẩu nấm ', 299000, 'Lẩu nấm, một món ăn thanh đạm nhưng đầy quyến rũ, là sự hòa quyện tinh tế của vô vàn loại nấm tươi ngon cùng nước dùng ngọt thanh, mang đến trải nghiệm ẩm thực khó quên.Lẩu nấm không chỉ là món ăn ngon mà còn rất tốt cho sức khỏe. Nấm là nguồn cung c', 'Lau_nam.jpg', 1, 1),
...
(20, 3, 'Lẩu cá chình', 250000, 'Lẩu cá chình mang đến một hương vị độc đáo và hấp dẫn. Thịt cá chình béo ngậy, dai ngon hòa quyện với nước dùng đậm đà, chua cay hoặc ngọt thanh tùy theo cách chế biến. Các loại rau ăn kèm tạo thêm sự cân bằng và tươi mát cho món ăn.', 'lau-ca-chinh.jpg', 1, 3);
...
--
ALTER TABLE `hoadon`
  MODIFY `IdHoaDon` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `nguoidung`
  MODIFY `id_nguoidung` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
